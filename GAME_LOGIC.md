...
| **Central** | Settlement | 1 Wood, 1 Brick, 1 Grain, 1 Wool | Grants 1 VP, 2 Expansion slots, and 2 adjacent Region cards. |
...
* Paid Swap: Pay 2 resources, place 1 card under a deck, then search any deck for a specific card.
...
* **Festival (Harp):** Both players receive 1 free resource. Exception: If one player has strictly more Skill Points than the other, only the player with the majority receives the resource.
* **Harvest (Sun):** Both players receive 1 free resource.
